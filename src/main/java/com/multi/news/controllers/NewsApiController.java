...
public class NewsApiController {
    ...
    @GetMapping("/{category}")
    public ResponseEntity<String> getNews(@PathVariable String category) throws JsonProcessingException{
        return ResponseEntity.status(HttpStatus.OK).body(newsApiService.newsGet(category).toString());
    }
